...
<style>
    /* عندما تكون الصفحة في الوضع الفاتح (بدون class dark) */
    html:not(.dark) body {
        background-color: #f8fafc !important;
        color: #0f172a !important;
    }

    /* تحويل العناوين والنصوص الرئيسية للون الداكن */
    html:not(.dark) h1,
    html:not(.dark) h2,
    html:not(.dark) h3,
    html:not(.dark) h4,
    html:not(.dark) p,
    html:not(.dark) span:not(.keep-white) {
        color: #1e293b !important;
    }

    /* تحويل البطاقات وخلفيات الأقسام للون الأبيض */
    /* تحويل البطاقات وخلفيات الأقسام للون الأبيض */
    ...
    /* تعديل زر التبديل نفسه ليكون واضحاً */
    #theme-toggle {
        position: fixed;
        bottom: 20px;
        left: 20px;
...
<head>
    ...
    <style>
        /* أضف هذا التنسيق داخل وسم style */
        #theme-toggle {
            width: 40px;
            height: 40px;
            border-radius: 8px;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-glass py-3">
        <div class="container">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <!-- ابحث عن هذا الجزء في أعلى الصفحة (الـ Navigation Bar) -->
                <div class="flex items-center gap-3">

                    <!-- ضَع كود زرار الدارك مود هنا في البداية -->
                    <button id="theme-toggle" aria-label="Toggle theme">
                        <svg class="moon-icon" viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
                            <path d="M12.3 2a10 10 0 0 0 9.7 11.2 10 10 0 1 1-9.7-11.2z" />
                        </svg>
                    ...
                    <!-- الأزرار القديمة الموجودة لديك بالفعل (اتركها كما هي) -->
                    <a href="..." class="...">لوحة التحكم</a>
                    <a href="..." class="...">...</a>
                        ...
                        <div class="col-sm-6 col-lg-4" id="resale-item-{{ $index }}">
                            <div class="custom-card p-4">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <span class="price-text fs-6">${{ number_format($listing->asking_price, 2) }}</span>
                                </div>
    ...
    <!-- Modal 2: عرض الجهاز للبيع في سوق المستعمل -->
    ...
    <script>
        ...
        // 3. Resale Logic (عرض الجهاز للبيع)
        ...
        // 4. Transfer Ownership Logic (شراء مستعمل)
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            // استرجاع الوضع المحفوظ أو اعتماده مظلماً افتراضياً
